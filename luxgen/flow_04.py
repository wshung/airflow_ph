...
def lxg_activity_task():
    ...
    lxg_n7act_weight = pd.read_excel('/home/paulhung/airflow/dags/luxgen/N7活動重要性_1026.xlsx', dtype={'date': date})
...
with DAG('lxg_tag_flow_04', schedule_interval='@daily', default_args=default_args) as dag:
    task1 = PythonOperator(
        task_id='lxg_activity',
        python_callable=lxg_activity_task,
