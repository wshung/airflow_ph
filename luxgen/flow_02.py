...
# 最近1次
Q1 = people_consumption_latest['cs_cost'].quantile(0.25)
Q3 = people_consumption_latest['cs_cost'].quantile(0.75)
people_consumption_latest['cs_cost_level'] = people_consumption_latest['cs_cost'].transform(get_lxg_cost_level)
cs_cost_level_latest = people_consumption_latest[people_consumption_latest['cs_cost_level'].notnull()]
# 近3個月
Q1 = people_consumption_3m_price['total_cost_3m'].quantile(0.25)
Q3 = people_consumption_3m_price['total_cost_3m'].quantile(0.75)
people_consumption_3m_price['cs_cost_level_3m'] = people_consumption_3m_price['total_cost_3m'].transform(get_lxg_cost_level)
cs_cost_level_3m = people_consumption_3m_price[people_consumption_3m_price['cs_cost_level_3m'].notnull()]
# 最近1年
Q1 = people_consumption_oneyear_price['total_cost_1y'].quantile(0.25)
Q3 = people_consumption_oneyear_price['total_cost_1y'].quantile(0.75)
people_consumption_oneyear_price['cs_cost_level_1y'] = people_consumption_oneyear_price['total_cost_1y'].transform(get_lxg_cost_level)
...
cstag_names_mapping1 = {
    ...
    # 'cs_item_f': '最近一次交易_服務項目',
    # 'cs_item_f_3m': '近三個月交易_服務項目',
    # 'cs_item_f_1y': '近一年交易_服務項目',
    # 'cs_carenergy_f': '最近一次交易_能源',
    # 'cs_carenergy_f_3m': '近三個月交易_能源',
    # 'cs_carenergy_f_1y': '近一年交易_能源',
    ...
    # '近三個月交易_交易天數',
    # '近一年交易_交易天數',
    # 'cs_area_code': '最近一次交易_交易區域',
    # 'cs_area_code_3m': '近三個月交易_交易區域',
    # 'cs_area_code_1y': '近一年交易_交易區域',
    # 'cs_location_code': '最近一次交易_交易據點',
    # 'cs_location_code_3m': '近三個月交易_交易據點',
    # 'cs_location_code_1y': '近一年交易_交易據點',
    ...
    # 'cs_freq_level_f_3m': '近三個月交易_消費頻率分級',
    # 'cs_freq_level_f_1y': '近一年交易_消費頻率分級',
    # 'cs_cost_pr': '近一年交易_消費金額分級',
    # 'cs_cost_pr_f_3m': '近三個月交易_消費金額分級',
    # 'cs_cost_pr_f_1y': '近一年交易_消費金額分級'
